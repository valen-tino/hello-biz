...
= 1.3.1 (2026-02-16) =
* Added: Conditional visibility for availability table section on all Single Project pages (targets `.elementor-element-58916b2.avaliable-table`) based on `has_any_properties` ACF field
