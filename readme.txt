...
* Fix: Change map previewer widget to grayscale & change default google map font to Proxima Nova
* Refactor: Added search functionality to Elementor Display Conditions
* Moved: Moved the LCP background image preloading from 'additional-shortcodes.php' to 'performance.php'
